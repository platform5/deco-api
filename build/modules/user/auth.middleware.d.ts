...
export declare class AuthMiddleware {
    ...
    static checkUserRoleAccess(prop: 'adminUserRoles' | 'adminShopRoles' | 'adminThreeRoles'): (req: Request, res: Response, next: NextFunction) => void;
    static checkRoleViaParamApp(roles: string | Array<string>): (req: Request, res: Response, next: NextFunction) => void;
    static allowOnlyRoles(roles?: Array<string>): (req: Request, res: Response, next: NextFunction) => void;
    ...
    static requestEmailOrMobileChange(type: 'email' | 'mobile'): (req: Request, res: Response, next: NextFunction) => void;
    static validateEmailOrMobileChange(type: 'email' | 'mobile'): (req: Request, res: Response, next: NextFunction) => void;
}
